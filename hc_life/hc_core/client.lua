...
function requestPlayerStats()
    TriggerServerEvent('getPlayerStats')
end

-- Listen for server response with player stats
RegisterNetEvent('receivePlayerStats')
AddEventHandler('receivePlayerStats', function(stats)
...
function updatePlayerStats(newStats)
    TriggerServerEvent('updatePlayerStats', newStats)
end
